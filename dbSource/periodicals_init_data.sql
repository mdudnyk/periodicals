INSERT INTO periodicals_db.locale values('uk', 'українська', 'грн', '/img/ua_flag.png');
INSERT INTO periodicals_db.locale values('en', 'english', 'uah', '/img/en_flag.png');



INSERT INTO periodicals_db.user values(1, 'uk', 'admin', 'admin', 'qwerty123', 'admin@gmail.com', 'ADMIN', 1000000, false);
INSERT INTO periodicals_db.user values(DEFAULT, 'uk', 'Myroslav', 'Dudnyk', 'qwerty123', 'mdudnyk.sps@gmail.com', 'CUSTOMER', 500000, false);
INSERT INTO periodicals_db.user values(DEFAULT, 'uk', 'Petro', 'Bamper', 'qwerty123', 'petro_bamper@gmail.com', 'CUSTOMER', 1000, false);
...
INSERT INTO periodicals_db.topic_translate values (1, 'uk', 'Автомобілі');
INSERT INTO periodicals_db.topic_translate values (2, 'en', 'Business');
INSERT INTO periodicals_db.topic_translate values (2, 'uk', 'Бізнес та фінанси');
INSERT INTO periodicals_db.topic_translate values (3, 'en', 'Computers & Technology');
INSERT INTO periodicals_db.topic_translate values (3, 'uk', 'Комп`ютери та технології');
INSERT INTO periodicals_db.topic_translate values (4, 'en', 'Crafts & Hobbies');
INSERT INTO periodicals_db.topic_translate values (4, 'uk', 'Хоббі');
INSERT INTO periodicals_db.topic_translate values (5, 'en', 'Design');
INSERT INTO periodicals_db.topic_translate values (5, 'uk', 'Дизайн');
INSERT INTO periodicals_db.topic_translate values (6, 'en', 'Food & Drinks');
INSERT INTO periodicals_db.topic_translate values (6, 'uk', 'Кулінарія');
INSERT INTO periodicals_db.topic_translate values (7, 'en', 'Gaming');
INSERT INTO periodicals_db.topic_translate values (7, 'uk', 'Ігри');
INSERT INTO periodicals_db.topic_translate values (8, 'en', 'Health & Fitness');
INSERT INTO periodicals_db.topic_translate values (8, 'uk', 'Здоров`я та фітнес');
INSERT INTO periodicals_db.topic_translate values (9, 'en', 'History & Science');
INSERT INTO periodicals_db.topic_translate values (9, 'uk', 'Історія та наука');
INSERT INTO periodicals_db.topic_translate values (10, 'en', 'Fashion & Lifestyle');
INSERT INTO periodicals_db.topic_translate values (10, 'uk', 'Мода та стиль життя');

INSERT INTO periodicals_db.topic_translate values (11, 'en', 'News');
INSERT INTO periodicals_db.topic_translate values (11, 'uk', 'Новини');
INSERT INTO periodicals_db.topic_translate values (12, 'en', 'Traveling');
INSERT INTO periodicals_db.topic_translate values (12, 'uk', 'Подорожі');
...
INSERT INTO periodical_translate VALUES (2, 'uk', 'Велика Британія', 'Англійська', 'Autosport — це журнал номер один для любителів автоспорту, який висвітлює як національні, так і міжнародні чемпіонати, забезпечуючи ідеальне поєднання останніх новин і коментарів, ексклюзивні інтерв’ю з найбільшими іменами автоспорту, а також глибокий аналіз усіх ключових гонки та події, які мають значення.');
...
INSERT INTO periodical_translate VALUES (3, 'uk', 'Велика Британія', 'Англійська', 'evo — провідний у світі бренд журналу про спорт і автомобілі преміум-класу. evo — це глобальний автомобільний бренд, створений найкращими письменниками та найталановитішими автомобільними фотографами світу');
...
INSERT INTO periodical_translate VALUES (5, 'uk', 'США', 'Англійська', 'Журнал Forbes – це діловий журнал, який орієнтований на ділові новини та фінансову інформацію');
...
INSERT INTO periodical_translate VALUES (7, 'uk', 'США', 'Англійська', 'Fast Company — провідний світовий бізнес-медіа-бренд, редактори якого зосереджуються на інноваціях у технологіях, лідерстві, ідеях, що змінюють світ, креативності та дизайні. Написаний для найпрогресивніших бізнес-лідерів і про них, Fast Company надихає читачів мислити експансивно, керувати цілеспрямовано, сприймати зміни та формувати майбутнє бізнесу');
...
INSERT INTO periodical_translate VALUES (14, 'uk', 'Велика Британія', 'Англійська', 'Відкрийте для себе новий журнал Mollie і отримуйте натхнення жити творчим життям. Знайдіть радість у виготовленні та створіть гарний будинок своїми руками. Насолоджуйтеся 14 сучасними трендовими проектами в кожному випуску від впливових дизайнерів і творців, включаючи старі фаворити, як-от шиття, в’язання та в’язання гачком. Досліджуйте свою творчість далі за допомогою вишивки, перфорації, мистецтва, переробки, DIY, макраме та глини PLUS смачної випічки, щоб зробити та поділитися');
...
INSERT INTO periodical_translate VALUES (15, 'uk', 'США', 'Англійська', 'Crochet! -  журнал, який показує сучасні тенденції в дизайні в’язання гачком, спочатку видавався як Crochet Home, починаючи з 1988 року');
...
INSERT INTO periodical_translate VALUES (19, 'uk', 'Канада', 'Англійська', 'Designlines, що виходить два рази на рік — це найкращий путівник по найкращим салонам сучасних меблів і магазинам декору в Торонто, а також по найбільш інноваційним житловим проектам міста.');
...
INSERT INTO periodical_translate VALUES (22, 'uk', 'Австралія', 'Англійська', 'Улюблена їжа та австралійський стиль життя – журнал Taste. Журнал оживляє всі нові та ексклюзивні рецепти, які приємно готувати та їсти, незалежно від того, чи хочете ви здорово поїсти посеред тижня чи приготувати якусь ексклюзивну страву');
...
INSERT INTO periodical_translate VALUES (23, 'uk', 'США', 'Англійська', 'Craft Beer & Brewing — це журнал для людей, які люблять пити та готувати чудове пиво');
...
INSERT INTO periodical_translate VALUES (24, 'uk', 'Швеція', 'Швецька', 'Ми є провідним журналом про їжу в Швеції. Ми висвітлюємо різноманітність шеф-кухарів, сомельє, барменів, виробників, заводчиків і гурманів, які контролюють і виготовляють їжу та напої у всьому світі. Gourmet постійно на кулінарній арені. Ласкаво просимо до Gourmet - найгарячішого водного журналу Швеції!');
...
INSERT INTO periodical_translate VALUES (25, 'uk', 'Велика Британія', 'Англійська', 'Retro Gamer пропонує досвід, недоступний більше ніде у світі. Відзначаючи захоплююче минуле відеоігор зі стилем і цілеспрямованістю, це інтелектуальне й емоційне повторне відкриття IP, які визначили індустрію. Відомий своїми інформативними й глибокими історіями, доступом до легендарних розробників і справжнім ентузіазмом щодо ігор, про які він розповідає, Retro Gamer, відзначений нагородами, є світовим явищем, яке любить ціла індустрія');
...
INSERT INTO periodical_translate VALUES (26, 'uk', 'Туреччина', 'Турецька', 'LEVEL - найбільш продаваний ігровий журнал в Туреччині. Пишемо новини, спеціальні новини, огляди та статті. Ми оновлюємося кожен день. Не кажучи вже про велику кількість останніх новин');
...
INSERT INTO periodical_translate VALUES (27, 'uk', 'Австралія', 'Англійська', 'Журнал, раніше відомий як OPS, тепер називається PLAY Australia! Це джерело номер один в Австралії для PlayStation 5, PlayStation 4 і PlayStation VR');
...
INSERT INTO periodical_translate VALUES (28, 'uk', 'Австралія', 'Англійська', 'Edge — це провідний багатоформатний журнал про відеоігри з майстерно написаними статтями про все, що стосується відеоігор. Edge занурюється в 8-бітне коріння ігор аж до гігантів сучасної епохи. Красиво оформлений журнал Edge відомий своїм приголомшливим малюнком, який не має собі рівних у жодному іншому ігровому журналі');
...
INSERT INTO periodical_translate VALUES (30, 'uk', 'Австралія', 'Англійська', 'Mindfood – це поєднання спільноти, здоров’я, навколишнього середовища, культури, подорожей, моди та їжі. Mindfood розумний, креативний і дуже крутий. Ідеально підходить для мислячих чоловіків і жінок, які жадають розумних, надихаючих ідей та інформації');
...
INSERT INTO periodical_translate VALUES (32, 'uk', 'Узбекистан', 'Англійська', 'Головне завдання журналу – надати майданчик вченим різних гуманітарних спеціальностей для обговорення проблем культури та культурології. Журнал публікує матеріали, пов\'язані з вивчення різних культурних практик.');
...
INSERT INTO periodical_translate VALUES (33, 'uk', 'Канада', 'Англійська', 'Вичерпний, авторитетний, чудово читабельний і неймовірно ілюстрований кольоровими фотографіями, картами, діаграмами, діаграмами та висувними плакатами. Як засіб розуміння історії Канади, людей, місць, культури, навколишнього середовища та дикої природи, немає іншого журналу, як Canadian Geographic');
...
INSERT INTO periodical_translate VALUES (36, 'uk', 'Іспанія', 'Іспанська', 'Подивіться, як журнал National Geographic History розпалює та вгамовує цікавість любителів історії та інформує та розважає всіх, хто цінує, що правда справді дивніша за вигадку, завдяки цифровій підписці сьогодні. І ця історія стосується не лише наших предків. Це про нас. Це про вас');
...
INSERT INTO periodical_translate VALUES (39, 'uk', 'Еквадор', 'Іспанська', 'Чітко, чесно, неупереджено, правдиво і вчасно, постійно інформувати про те, що відбувається в місті, країні та світ. А також пропонувати елементи для роздумів про поточні події зі своїх редакційних просторів, аналізу, розслідувань і глибокої журналістики');
...
INSERT INTO periodical_translate VALUES (41, 'uk', 'Україна', 'Українська', 'Газета для всієї родини: про політику, гроші, скандали, відомих людей, спорт, культуру, дім, здоров’я, їжу, сад-город, життєві історії, корисні поради, а також гороскоп, кросворди та анекдоти. Виходить щотижня у четвер');
...
INSERT INTO periodical_translate VALUES (43, 'uk', 'Україна', 'Українська', 'Vogue Україна (англ. Vogue Ukraine) — українське видання американського щомісячного журналу про моду та стиль життя Vogue. Журнал виходить з березня 2013 року, ставши двадцять першим місцевим виданням Vogue');