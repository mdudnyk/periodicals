...
<%@ include file="fragment/Header.jspf" %>
    ...
    <div class="content_topper">
        <a href="controller?cmd=MY_SUBSCRIPTIONS" class="parent_page_link">My Subscriptions</a>
        <i class="small material-icons" style="margin: 0 10px; opacity: 70%;">navigate_next</i>
        <a style="color: #27c18a; font-weight: 500;">Details</a>
    </div>
    <div class="body_top_block_wrapper">
        <div class="body_top_block">
            <div class="top_block_img_container">
                <img class="img_container_title" id="title_img" src="<ct:imageEncoderBase64 image_name="${requestScope.periodical.getTitleImgLink()}"/>">
            </div>
            <div class="top_block_text_block">
                <h1 class="text_block_title">FAST COMPANY</h1>
                <p>Topic: <span>Bussiness</span></p>
                <p>Origin country: <span>United States</span></p>
                <p>Language: <span>English</span></p>
                <p style="padding-bottom: 20px; border-bottom: 1px solid rgba(0, 0, 0, 0.1);">
                    Publishing frequency: <span>1 per month</span>
                </p>
                <p>Subscription calendar:</p>
