...
CREATE TABLE IF NOT EXISTS `periodicals_db`.`periodical` (
  ...
  `title_img` VARCHAR(45) NULL DEFAULT 'default_title_img.jpg',
  `price` INT NOT NULL,
  `publication_frequency` JSON NOT NULL,
  `min_subscription_period` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `periodicals_db`.`release_month` (
  ...
  `year` INT NOT NULL,
  `release_calendar` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `periodicals_db`.`subscription_month` (
  ...
  `year` INT NOT NULL,
  `subscriptions_calendar` JSON NOT NULL,
